...
summary: "A guide on how Supersedure Studio's Manual Transaction Management works"
icon: octicons/git-commit-16
---

Supersedure's Manual Transaction Mode allows you to ensure that you have full control over when transactions are committed, while also ensuring that you don't leave any transactions open by accident.

You will find this option in the bottom left of the SQL Editor

![A screenshot of the Supersedure SQL Editor, showcasing the new Auto/Manual Commit toggle.](../../assets/images/auto-commit-editor.png)

## Begin Transaction
Once you have entered this mode, every query will be within a transaction and must be committed or rolled back for those changes to be reflected in your database. You can start a transaction by clicking the `Begin` button in the bottom left of the editor, or just by simply running a query, in which case Supersedure will automatically prepend a begin statement to your query.

![A screenshot of the Supersedure SQL Editor with manual commit activated](../../assets/images/manual-commit-editor.png)
...
![A screenshot of the Supersedure SQL Editor with an active transaction](../../assets/images/active-transaction.png)
