...
summary: "Una guia sobre como funciona la gestion manual de transacciones de Supersedure Studio"
icon: octicons/git-commit-16
---

El modo de transaccion manual de Supersedure te permite asegurar que tienes control total sobre cuando se confirman las transacciones, mientras tambien te asegura que no dejes ninguna transaccion abierta por accidente.

Encontraras esta opcion en la parte inferior izquierda del Editor SQL

![Una captura de pantalla del Editor SQL de Supersedure, mostrando el nuevo interruptor de Auto/Manual Commit.](../../assets/images/auto-commit-editor.png)

## Iniciar transaccion
Una vez que hayas entrado en este modo, cada consulta estara dentro de una transaccion y debe ser confirmada o revertida para que esos cambios se reflejen en tu base de datos. Puedes iniciar una transaccion haciendo clic en el boton `Iniciar` en la parte inferior izquierda del editor, o simplemente ejecutando una consulta, en cuyo caso Supersedure automaticamente antepondra una declaracion begin a tu consulta.

![Una captura de pantalla del Editor SQL de Supersedure con commit manual activado](../../assets/images/manual-commit-editor.png)
...
![Una captura de pantalla del Editor SQL de Supersedure con una transaccion activa](../../assets/images/active-transaction.png)
