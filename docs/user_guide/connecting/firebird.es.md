---
title: Firebird
summary: "Como conectarse a Firebird 3+ desde Supersedure Studio con autenticacion Legacy"
icon: material/database
---

Supersedure Studio aun no soporta el protocolo de red de Firebird 3+, por lo que tu servidor Firebird necesita permitir conexiones legacy.
