...
When you purchase a Supersedure Studio license by default you'll be given a license name and license key to enter into the app.

This license key and name will be validated against the Supersedure Studio servers.
...
1. Go to [the license management dashboard](https://app.supersedurestudio.io/purchases)
...
4. Save the file as `license.json` in the Supersedure Studio configuration directory:
